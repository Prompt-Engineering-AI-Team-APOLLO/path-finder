...
down_revision: str | None = "20260412_03"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("outbound_stops", sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_flight_bookings_booking_reference"), table_name="flight_bookings"
    )
